...
public protocol APIRequestProtocol {
    func get<T: Codable>(url: URL, token: String?) -> AnyPublisher<T, Error>
    func get<T: Codable>(resUrl: URL, token: String?, dataId: String) -> AnyPublisher<T, Error>
...
public class APIRequest: APIRequestProtocol {
    ...
    /// GET METHOD
    public func get<T: Codable>(url: URL, token: String?) -> AnyPublisher<T, Error> {
    ...
    /// GET METHOD
    public func get<T: Codable>(resUrl: URL, token: String?, dataId: String) -> AnyPublisher<T, Error> {
