...
public class WebRTCMessage: Codable {
     ...
     */
    public class func createAnswerMessage(sdp: String, _ recipientClientId: String) -> WebRTCMessage {
        ...
        return WebRTCMessage("SDP_ANSWER", recipientClientId, "", encodedAnswer)
    }
     ...
     */
    public class func createOfferMessage(sdp: String, senderClientId: String) -> WebRTCMessage {
        ...
        return WebRTCMessage("SDP_OFFER", "", senderClientId, encodedOffer)
    }
    ...
    public class func createIceCandidateMessage(candidate: RTCIceCandidate, _ master: Bool,
                                                ...
                                                senderClientId: String) -> WebRTCMessage {
        ...
        if master {
            ...
            return WebRTCMessage("ICE_CANDIDATE", recipientClientId, "",
            ...
            return WebRTCMessage("ICE_CANDIDATE", senderClientId, messagePayload.data(using: .utf8)!.base64EncodedString())
        }
    }
}
