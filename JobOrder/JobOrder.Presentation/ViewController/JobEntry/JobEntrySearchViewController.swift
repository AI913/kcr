...
class JobEntrySearchViewController: UIViewController {
    ...
    // MARK: - IBOutlet
    @IBOutlet weak var actionLibraryCollection: UICollectionView!
    @IBOutlet weak var continueButton: UIButton!

    // MARK: - Variable
    var viewData: JobEntryViewData!
    var presenter: JobEntrySearchViewControllerProtocol!
    private var computedCellSize: CGSize?

    func inject(viewData: JobEntryViewData) {
        self.viewData = viewData
        presenter = JobEntryBuilder.ActionLibrarySelection().build(vc: self, viewData: viewData)
    }
    ...
    override func viewDidLoad() {
        ...
        actionLibraryCollection?.allowsMultipleSelection = true
    }
...
extension JobEntrySearchViewController: UICollectionViewDelegate {
