//
//  JobEntryConfigurationPageViewController.swift
...
class JobEntryConfigurationPageViewController: UIViewController {

    // MARK: - Variable
    private var controllers: [JobEntryConfigurationContainerViewController] = [
        StoryboardScene.JobEntry.jobEntryParameters.instantiate(),
        StoryboardScene.JobEntry.jobEntryRemarks.instantiate()
    ]

    weak var _delegate: JobEntryConfigurationViewControllerProtocol?
