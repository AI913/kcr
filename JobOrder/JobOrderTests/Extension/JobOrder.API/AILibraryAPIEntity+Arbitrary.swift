//
//  AILibraryAPIEntity+Arbitrary.swift
//  JobOrder.APITests
//
...
extension AILibraryAPIEntity.Data: Arbitrary {
    public static var arbitrary: Gen<Self> {
        return Gen<Self>.compose { c in
            return AILibraryAPIEntity.Data(id: c.generate(using: FakeFactory.shared.uuidStringGen),
                                           name: c.generate(),
                                           type: c.generate(),
...
extension AILibraryAPIEntity.Data.Requirement: Arbitrary {
    public static var arbitrary: Gen<Self> {
        return Gen<Self>.compose { c in
            return AILibraryAPIEntity.Data.Requirement()
        }
    }
}
